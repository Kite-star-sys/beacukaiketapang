        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header flex items-center justify-between">
                    ...
                    <a href="{{ url('kepala_kantor/surat/create') }}" class="btn btn-sm btn-success">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <x-table.td-action>
                                    <div class="btn-group dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            @if ($status_baru)
                                                <li><a class="dropdown-item" href="{{ url('kepala_kantor/surat/lihat',$surat->id) }}">Lihat Surat</a></li>
                                ...
                                <x-modal.modal-verifikasi
                                    ...
                                    action="{{ url('kepala_kantor/surat/verifikasi',$surat->id) }}"
                                    icons="file-check"
                                ...
                                <x-modal.modal-verifikasi
                                    ...
                                    action="{{ url('kepala_kantor/surat/tangguhkan',$surat->id) }}"
                                ...
                                <x-modal.modal-verifikasi
                                    ...
                                    action="{{ url('kepala_kantor/surat/terima',$surat->id) }}"
                                ...
                                />
                                <!-- Modal Kirim Data -->
                                <x-modal.modal-tambah id="kirimSurat{{ $surat->id }}" action="{{ url('kepala_kantor/surat/kirim',$surat->id) }}">
                                    <div class="p-8">
                                        <div class="pb-4">
